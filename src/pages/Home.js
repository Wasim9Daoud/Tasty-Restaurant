...
const Home = () => {
  return (
    <>
      <div className="md:home home-mob w-full">
        <div className="h-[100%] mx-auto max-w-[1380px]">
              {/* button container */}
              <div className="flex flex-col md:ml-[50px] ml-[25px] pt-[135px] justify-center items-center w-[100%] h-[50%] pr-[70px]">
                ...
                <Link to="/services" className="animate-pulse md:ml-[5px]">
