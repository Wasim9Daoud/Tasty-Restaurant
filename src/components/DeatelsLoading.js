    ...
    <div className="bg-gray-400 w-full h-full">
      <div className=" max-w-[1380px] mx-auto">
        <div className=" p-[10px] flex flex-col  justify-center md:items-start items-center pt-[50px] pb-[32px] gap-[30px]">
          ...
          <div className="flex justify-center w- md:w-[50%]">
            <button className=" px-[10px] animate-pulse py-[5] bg-gray-300 w-[200px] h-[50px] rounded-md">
            </button>
          </div>
        </div>
      </div>
